<div class="modal-header">
    <div class="pull-right">
        ...
        <button type="button" class="btn btn-xs btn-info" ng-click="edit()" ze-auth="{id_project : card.id_project, right : 'card'}">
...
<div class="modal-body table">
    <div class="clearfix">
        ...
        <h4 ng-if="card.due_date != '0000-00-00'">Echéance : <i>{{ card.due_date | date:'dd/MM/yyyy HH:mm:ss' }}</i></h4>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li role="presentation" ng-click="goToTabCard('timers')" ng-class="isActiveCard('timers') ? 'active' : ''" ze-auth="{id_project : card.id_project, right : 'card'}">
                    <a href="#">Temps</a>
                </li>
            </ul>
        </div>
