app.controller("ComZeappsProjectArchivesCtrl", ["$scope", "$location", "zeHttp", "$uibModal", "$filter", "zeProject", "menu",
	function ($scope, $location, zhttp, $uibModal, $filter, zeProject, menu) {
